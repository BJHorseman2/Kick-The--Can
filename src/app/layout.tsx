...
const DESCRIPTION =
  'Fly a neon drone over photorealistic Paris, San Francisco and Chicago. Steal the loot, thread the rings, escape through the portal. Plays in your browser — phone or desktop.';
